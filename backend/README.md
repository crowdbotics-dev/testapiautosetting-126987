...
## Project Structure
    ...
    ├── testapiautosetting_126987  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126987`
...
2. Clone this repo and `cd testapiautosetting_126987`
